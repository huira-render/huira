...
namespace huira {
    ...
    public:
        ...
        void set_orientation(const Rotation<TFloat>& orientation) const { this->safe_get()->set_orientation(orientation); }
        ...
        void set_spice(const std::string& spice_origin, const std::string& spice_ref) const { this->safe_get()->set_spice(spice_origin, spice_ref); }
        void set_position_from_spice(const std::string& spice_origin) const { this->safe_get()->set_position_from_spice(spice_origin); }
        void set_orientation_from_spice(const std::string& spice_ref) const { this->safe_get()->set_orientation_from_spice(spice_ref); }
    };
}
