...
namespace huira {
/**
 * @brief Represents a 3D rotation using a 3x3 matrix, with various construction and conversion
 * utilities.
 *
 * Provides static methods for constructing rotations from matrices, quaternions, axis-angle, Euler
 * angles, and basis vectors. Supports conversion to/from quaternions, matrix, and axis
 * representations, as well as composition and application to vectors.
 *
...
class Rotation {
  public:
    ...
    static Rotation extrinsic_euler_angles(units::Radian angle1,
                                           units::Radian angle2,
                                           units::Radian angle3,
                                           std::string sequence = "XYZ");
    static Rotation intrinsic_euler_angles(units::Radian angle1,
                                           units::Radian angle2,
                                           units::Radian angle3,
                                           std::string sequence = "XYZ");
