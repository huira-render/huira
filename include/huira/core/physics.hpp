 ...
 *
 * Provides functions for photon energy, Planck's law, black-body radiation, V-band photometry, and
 * relativistic aberration. Includes both scalar and spectral (template) versions for use in
...
template <IsSpectral TSpectral>
TSpectral visual_magnitude_to_irradiance(double visual_magnitude,
