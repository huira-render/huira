...
namespace huira {
    ...
    void write_image_jpeg(const fs::path& filepath, const ImageBundle<RGB>& output_image, int quality = 95);
    void write_image_jpeg(const fs::path& filepath, const ImageBundle<float>& output_image, int quality = 95);
}
