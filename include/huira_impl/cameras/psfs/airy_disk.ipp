...
AiryDisk<TSpectral>::AiryDisk(units::Meter focal_length,
                              units::Meter pitch_x,
                              units::Meter pitch_y,
                              units::Meter aperture_diameter,
                              int radius,
                              int banks)
 ...
 *
 * Computes the intensity at the specified (x, y) offset from the center, using the Airy disk
 * formula.
 *
