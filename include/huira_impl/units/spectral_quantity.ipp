...
constexpr SpectralQuantity<Dim, Scale, TSpectral>::SpectralQuantity() : value_{0}
{
}
...
{
    constexpr double other_ratio =
        static_cast<double>(OtherScale::num) / static_cast<double>(OtherScale::den);
...
template <IsDimensionality Dim, typename Scale, IsSpectral TSpectral>
constexpr bool
SpectralQuantity<Dim, Scale, TSpectral>::operator==(const SpectralQuantity& other) const
{
