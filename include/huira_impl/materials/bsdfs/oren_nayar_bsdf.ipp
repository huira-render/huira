...
template <IsSpectral TSpectral>
TSpectral OrenNayarBSDF<TSpectral>::eval(const Vec3<float>& wo,
                                         const Vec3<float>& wi,
...
template <IsSpectral TSpectral>
BSDFSample<TSpectral> OrenNayarBSDF<TSpectral>::sample(const Vec3<float>& wo,
                                                       const Interaction<TSpectral>& isect,
...
template <IsSpectral TSpectral>
float OrenNayarBSDF<TSpectral>::pdf(const Vec3<float>& wo,
                                    const Vec3<float>& wi,
                                    const Interaction<TSpectral>& isect,
                                    const ShadingParams<TSpectral>& params) const
{
