...
template <IsSpectral TSpectral>
TSpectral HapkeBSDF<TSpectral>::eval(const Vec3<float>& wo,
                                     const Vec3<float>& wi,
...
template <IsSpectral TSpectral>
BSDFSample<TSpectral> HapkeBSDF<TSpectral>::sample(const Vec3<float>& wo,
                                                   const Interaction<TSpectral>& isect,
...
template <IsSpectral TSpectral>
float HapkeBSDF<TSpectral>::pdf(const Vec3<float>& wo,
                                const Vec3<float>& wi,
                                const Interaction<TSpectral>& isect,
                                const ShadingParams<TSpectral>& params) const
{
