...
namespace huira {
    ...
    std::vector<float> TrajectoryArc::solve_quadratic_(float a, float b, float c, float t_min, float t_max)
    {
        constexpr float eps = 1e-10f;
     ...
     */
    std::vector<float> TrajectoryArc::solve_cubic_(float a, float b, float c, float d, float t_min, float t_max)
    {
        constexpr float eps = 1e-10f;
