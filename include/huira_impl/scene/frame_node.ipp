...
FrameNode<TSpectral>::FrameNode(Scene<TSpectral>* scene) : Node<TSpectral>(scene)
{
}
...
void FrameNode<TSpectral>::delete_child(std::weak_ptr<Node<TSpectral>> child_weak)
{
    ...
    if (child->parent_ != this) {
        HUIRA_THROW_ERROR(
            this->get_info() +
            " - delete_child() called with a child that does not belong to this node");
    }
 ...
 */
template <IsSpectral TSpectral>
std::weak_ptr<Instance<TSpectral>>
FrameNode<TSpectral>::new_instance(Primitive<TSpectral>* primitive)
{
...
template <IsSpectral TSpectral>
std::weak_ptr<Instance<TSpectral>>
FrameNode<TSpectral>::new_instance(UnresolvedObject<TSpectral>* unresolved_object)
{
...
template <IsSpectral TSpectral>
std::weak_ptr<Instance<TSpectral>>
FrameNode<TSpectral>::new_instance(CameraModel<TSpectral>* camera_model)
{
