...
read_image(ImageFormat fmt, const unsigned char* data, std::size_t size, bool read_alpha)
{
...
read_image_mono(ImageFormat fmt, const unsigned char* data, std::size_t size, bool read_alpha)
{
    if (fmt == ImageFormat::IMAGE_FORMAT_BMP) {
