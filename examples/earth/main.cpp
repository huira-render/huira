...
int main(int argc, char** argv)
{
    ...
    auto earth_roughness = huira::read_image_mono(textures_path / "8k_earth_roughness_map.tif");
    ...
    auto earth_clouds_alpha = huira::read_image_mono(textures_path / "8k_earth_clouds.jpg");
