...
inline void bind_distortion_coefficients(py::module_& m)
{
    ...
    py::class_<DistortionCoefficients>(m, "DistortionCoefficients").def(py::init<>());
    ...
    py::class_<BrownCoefficients, DistortionCoefficients>(m, "BrownCoefficients")
        ...
        .def(py::init<double, double, double, double, double>(),
             ...
             py::arg("p1"),
             py::arg("p2"),
             "Construct Brown distortion coefficients with radial (k1, k2, k3) and tangential (p1, "
             "p2) parameters")
        ...
        .def("__repr__", [](const BrownCoefficients& c) {
            return "BrownCoefficients(k1=" + std::to_string(c.k1) + ", k2=" + std::to_string(c.k2) +
                   ", k3=" + std::to_string(c.k3) + ", p1=" + std::to_string(c.p1) +
    ...
    py::class_<OpenCVCoefficients, DistortionCoefficients>(m, "OpenCVCoefficients")
        ...
        .def("__repr__", [](const OpenCVCoefficients& c) {
            return "OpenCVCoefficients(k1=" + std::to_string(c.k1) +
                   ", k2=" + std::to_string(c.k2) + ", k3=" + std::to_string(c.k3) +
                   ", k4=" + std::to_string(c.k4) + ", k5=" + std::to_string(c.k5) +
                   ", k6=" + std::to_string(c.k6) + ", p1=" + std::to_string(c.p1) +
                   ", p2=" + std::to_string(c.p2) + ", s1=" + std::to_string(c.s1) +
                   ", s2=" + std::to_string(c.s2) + ", s3=" + std::to_string(c.s3) +
    ...
    py::class_<OwenCoefficients, DistortionCoefficients>(m, "OwenCoefficients")
        ...
        .def("__repr__", [](const OwenCoefficients& c) {
            return "OwenCoefficients(e1=" + std::to_string(c.e1) + ", e2=" + std::to_string(c.e2) +
                   ", e3=" + std::to_string(c.e3) + ", e4=" + std::to_string(c.e4) +
                   ", e5=" + std::to_string(c.e5) + ", e6=" + std::to_string(c.e6) + ")";
        });
}
