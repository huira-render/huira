...
namespace huira {
    ...
    inline void bind_interval(py::module_& m) {
        py::class_<Interval>(m, "Interval")
            ...
            return "<Interval " + ei.start.to_iso_8601() +
                " to " + ei.end.to_iso_8601() +
