...
inline void bind_time(py::module_& m)
{
    ...
    py::class_<Time>(m, "Time")
        ...
        .def_static("from_julian_date",
                    &Time::from_julian_date,
                    py::arg("jd"),
                    py::arg("scale"),
                    "Create from a Julian Date in the specified timescale")
        .def_static("from_modified_julian_date",
                    &Time::from_modified_julian_date,
                    py::arg("mjd"),
                    py::arg("scale"),
        ...
        .def("to_julian_date", &Time::to_julian_date, py::arg("scale") = TimeScale::TDB)
        .def("to_modified_julian_date",
             &Time::to_modified_julian_date,
             py::arg("scale") = TimeScale::TDB)
        .def("julian_years_since_j2000",
             &Time::julian_years_since_j2000,
        ...
        .def(
            "__add__",
            [](const Time& self, const py::object& delta) -> Time {
        ...
        // Repr
        .def("__repr__", [](const Time& t) { return "<Time " + t.to_iso_8601() + ">"; })
