...
void bind_quantity_type(py::module& m, const std::string& name)
{
    ...
    py::class_<UnitType>(m, name.c_str(), class_doc.c_str())
        ...
        .def(py::init<double>(), py::arg("value"), ("Create a " + name + " from a float.").c_str())
        .def(py::init<int>(), py::arg("value"), ("Create a " + name + " from an int.").c_str())
        .def(py::init<float>(), py::arg("value"), ("Create a " + name + " from a float.").c_str())
        .def("to_si",
             static_cast<double (UnitType::*)() const>(&UnitType::to_si),
             "Return the value converted to SI base units (returns float).")
        .def("raw_value", &UnitType::raw_value, "Return the raw value in this unit's scale.")
        .def("__str__", &UnitType::to_string)
        .def("__repr__",
             [name](const UnitType& self) {
                 return name + "(" + std::to_string(self.raw_value()) + ")";
             })
        // Cross-unit addition (different scales, same dimension)
        .def(
            "__add__",
            [](const UnitType& self, const py::object& other) -> UnitType {
        ...
        .def(
            "__eq__",
            [](const UnitType& self, const py::object& other) {
                return self.to_si() == other.attr("to_si")().cast<double>();
            },
            py::arg("other"),
            "Equal comparison via SI values.")
        .def(
            "__lt__",
            [](const UnitType& self, const py::object& other) {
                return self.to_si() < other.attr("to_si")().cast<double>();
            ...
            py::arg("other"),
            "Less-than comparison via SI values.")
        .def(
            "__le__",
            [](const UnitType& self, const py::object& other) {
                return self.to_si() <= other.attr("to_si")().cast<double>();
            ...
            py::arg("other"),
            "Less-or-equal comparison via SI values.")
        .def(
            "__gt__",
            [](const UnitType& self, const py::object& other) {
                return self.to_si() > other.attr("to_si")().cast<double>();
            ...
            py::arg("other"),
            "Greater-than comparison via SI values.")
        .def(
            "__ge__",
            [](const UnitType& self, const py::object& other) {
                return self.to_si() >= other.attr("to_si")().cast<double>();
            ...
            py::arg("other"),
            "Greater-or-equal comparison via SI values.");
}
...
static void bind_units(py::module& m)
{
    ...
    bind_quantity_type<huira::units::WattsPerMeterSquaredSteradian>(
        m, "WattsPerMeterSquaredSteradian");
    ...
    register_unit_conversions<huira::units::Meter,
                              huira::units::Kilometer,
                              huira::units::Centimeter,
                              huira::units::Millimeter,
                              huira::units::Micrometer,
                              huira::units::Nanometer,
                              huira::units::AstronomicalUnit,
                              huira::units::Foot,
                              huira::units::Yard,
                              huira::units::Mile>(m);

    // Mass -> Kilogram
    register_unit_conversions<huira::units::Kilogram, huira::units::Gram, huira::units::Milligram>(
        m);

    // Time -> Second
    register_unit_conversions<huira::units::Second,
                              huira::units::Femtosecond,
                              huira::units::Nanosecond,
                              huira::units::Microsecond,
                              huira::units::Millisecond,
                              huira::units::Minute,
                              huira::units::Hour,
                              huira::units::Day,
                              huira::units::SiderealDay>(m);

    // Temperature -> Kelvin
    register_unit_conversions<huira::units::Kelvin,
                              huira::units::Celsius,
                              huira::units::Fahrenheit>(m);

    // Angle -> Radian
    register_unit_conversions<huira::units::Radian,
                              huira::units::Degree,
                              huira::units::Arcminute,
                              huira::units::Arcsecond>(m);

    // Solid Angle -> Steradian
    register_unit_conversions<huira::units::Steradian, huira::units::SquareDegree>(m);

    // Speed -> MetersPerSecond
    register_unit_conversions<huira::units::MetersPerSecond,
                              huira::units::KilometersPerSecond,
                              huira::units::MilesPerHour,
                              huira::units::KilometersPerHour>(m);

    // Frequency -> Hertz
    register_unit_conversions<huira::units::Hertz,
                              huira::units::Kilohertz,
                              huira::units::Megahertz,
                              huira::units::Gigahertz,
                              huira::units::Terahertz>(m);

    // Force -> Newton
    register_unit_conversions<huira::units::Newton, huira::units::Kilonewton>(m);

    // Pressure -> Pascal
    register_unit_conversions<huira::units::Pascal, huira::units::Kilopascal>(m);

    // Energy -> Joule
    register_unit_conversions<huira::units::Joule,
                              huira::units::Kilojoule,
                              huira::units::Megajoule,
                              huira::units::ElectronVolt>(m);

    // Power -> Watt
    register_unit_conversions<huira::units::Watt,
                              huira::units::Milliwatt,
                              huira::units::Kilowatt,
                              huira::units::Megawatt,
...
void bind_spectral_units_for_type(py::module& m)
{
    ...
    bind_spectral_quantity_type<huira::units::SpectralMilliwatts<TSpectral>>(m,
                                                                             "SpectralMillwatts");
    bind_spectral_quantity_type<huira::units::SpectralWatts<TSpectral>>(m, "SpectralWatts");
    bind_spectral_quantity_type<huira::units::SpectralKilowatts<TSpectral>>(m, "SpectralKilowatts");
    bind_spectral_quantity_type<huira::units::SpectralMegawatts<TSpectral>>(m, "SpectralMegawatts");
    bind_spectral_quantity_type<huira::units::SpectralGigawatts<TSpectral>>(m, "SpectralGigawatts");
