    ...
    cls
        ...
        .def(
            ...
            [](const BoundType& self,
               ...
               const py::object& y,
               const py::object& z) {
                self.set_position(detail::unit_from_py<units::Meter>(x),
        ...
        .def(
            ...
            [](const BoundType& self,
               ...
               const py::object& vy,
               const py::object& vz) {
                self.set_velocity(detail::unit_from_py<units::MetersPerSecond>(vx),
        ...
        .def("set_rotation_local_to_parent",
             py::overload_cast<const Mat3<double>&>(&HandleType::set_rotation_local_to_parent,
                                                    py::const_),
             py::arg("matrix"))
        .def("set_rotation_local_to_parent",
             py::overload_cast<const Quaternion<double>&>(&HandleType::set_rotation_local_to_parent,
                                                          py::const_),
             py::arg("quaternion"))
        .def(
            "set_rotation_local_to_parent",
        ...
        .def("set_rotation_parent_to_local",
             py::overload_cast<const Mat3<double>&>(&HandleType::set_rotation_parent_to_local,
                                                    py::const_),
             py::arg("matrix"))
        .def("set_rotation_parent_to_local",
             py::overload_cast<const Quaternion<double>&>(&HandleType::set_rotation_parent_to_local,
                                                          py::const_),
             py::arg("quaternion"))
        .def(
            "set_rotation_parent_to_local",
            [](const BoundType& self, const Vec3<double>& axis, const py::object& angle) {
        ...
        .def(
            ...
            [](const BoundType& self,
               ...
               const std::string& sequence) {
                self.set_euler_angles(detail::unit_from_py<units::Radian>(x),
        ...
        .def(
            ...
            [](const BoundType& self,
               ...
               const py::object& wy,
               const py::object& wz) {
                self.set_angular_velocity(detail::unit_from_py<units::RadiansPerSecond>(wx),
        ...
        .def("set_spice", &HandleType::set_spice, py::arg("spice_origin"), py::arg("spice_frame"))
