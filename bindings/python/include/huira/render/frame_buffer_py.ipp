...
void bind_frame_buffer(py::module_& m)
{
    ...
    py::class_<FB>(m, name.c_str())
        ...
        .def_property_readonly(
            "depth",
            [](FB& fb) -> Image<float>& { return fb.depth(); },
        ...
        .def_property_readonly(
            "camera_normals",
            [](FB& fb) -> Image<Vec3<float>>& { return fb.camera_normals(); },
            py::return_value_policy::reference_internal)
        ...
        .def_property_readonly(
            "world_normals",
            [](FB& fb) -> Image<Vec3<float>>& { return fb.world_normals(); },
            py::return_value_policy::reference_internal)

        // -- Received Direct Power ----------------------------------------
        .def("enable_received_direct_power",
             &FB::enable_received_direct_power,
             py::arg("enable") = true)
        .def("has_received_direct_power", &FB::has_received_direct_power)
        .def_property_readonly(
            "received_direct_power",
            [](FB& fb) -> Image<TSpectral>& { return fb.received_direct_power(); },
            py::return_value_policy::reference_internal)

        // -- Received Indirect Power --------------------------------------
        .def("enable_received_indirect_power",
             &FB::enable_received_indirect_power,
             py::arg("enable") = true)
        .def("has_received_indirect_power", &FB::has_received_indirect_power)
        .def_property_readonly(
            "received_indirect_power",
            [](FB& fb) -> Image<TSpectral>& { return fb.received_indirect_power(); },
            py::return_value_policy::reference_internal)
        ...
        .def_property_readonly(
            "received_power",
            [](FB& fb) -> Image<TSpectral>& { return fb.received_power(); },
            py::return_value_policy::reference_internal)
        ...
        .def_property_readonly(
            "sensor_response",
            [](FB& fb) -> Image<SensorT>& { return fb.sensor_response(); },
            py::return_value_policy::reference_internal)
        ...
        .def("__repr__", [](const FB& fb) {
            ...
            if (fb.has_world_normals()) {
                os << ", world_normals";
            }
            if (fb.has_received_direct_power()) {
                os << ", received_direct_power";
            }
            if (fb.has_received_indirect_power()) {
                os << ", received_indirect_power";
            }
